...
import { PATH_LANDING, getOAuthCallbackUri } from '@/constants/platform-routes';
...
const Layout = observer(() => {
    ...
    const isLandingPage = pathname === PATH_LANDING || pathname === '';
    ...
    useEffect(() => {
        ...
        const checkOIDCEnabledWithMissingAccount =
            !isEndpointPage && !isCallbackPage && !isLandingPage && !clientHasCurrency;
                ...
                if (tmbEnabled) {
                    ...
                    try {
                        await requestOidcAuthentication({
                            redirectCallbackUri: getOAuthCallbackUri(),
