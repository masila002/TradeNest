...
/** Node 22.21.0 can crash HTTPS dev server (shouldUpgradeCallback). Use Node 20 / 22.21.1+, or DISABLE_DEV_SSL=1 */
const useDevSsl = process.env.DISABLE_DEV_SSL !== '1' && process.env.DISABLE_DEV_SSL !== 'true';
